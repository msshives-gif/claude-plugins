#!/bin/bash
# Manual (non-plugin) install: merge the task-forensics hook into
# ~/.claude/settings.json (or a settings file given as $1).
...
script_path = os.path.join(plugin, "hooks", "wrap.py")
